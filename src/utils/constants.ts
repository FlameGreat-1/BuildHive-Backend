...
export const ERROR_CODES = {
  ...
  AUTH_PHONE_NOT_VERIFIED: 'AUTH_008',
  AUTH_TOKEN_EXPIRED: 'AUTH_009',
  AUTH_TOKEN_INVALID: 'AUTH_010',
  AUTH_INSUFFICIENT_PERMISSIONS: 'AUTH_011',
  AUTH_PASSWORD_EXPIRED: 'AUTH_012',
  AUTH_MFA_REQUIRED: 'AUTH_013',
  AUTH_MFA_INVALID: 'AUTH_014',
  ...
  SYS_UNHANDLED_REJECTION: 'SYS_012',
  SYS_UNCAUGHT_EXCEPTION: 'SYS_013',
  SYS_DATABASE_CONNECTION_ERROR: 'SYS_014',
  SYS_SERVER_ERROR: 'SYS_015',
  SYS_STARTUP_ERROR: 'SYS_016',
} as const;
