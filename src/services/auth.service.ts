...
export class AuthService {
  ...
  public async verifyPhone(verificationData: VerificationRequest): Promise<{
    ...
    try {
      ...
      if (!success) {
        logger.security('PHONE_VERIFICATION_FAILED', {
          ...logContext,
...
export const verifyUserEmail = async (verificationData: VerificationRequest) => {
  return await authService.verifyEmail(verificationData);
};

export const verifyUserPhone = async (verificationData: VerificationRequest) => {
